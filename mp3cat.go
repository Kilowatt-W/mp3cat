...
var destMp3dir string
var destMp3file string
...
func main() {
	...
	if parser.Found("dir") {
		...
		files = globs
		destMp3dir = parser.GetString("dir")
		destMp3file = strings.Replace(parser.GetString("o"), "#mp3dir#", destMp3dir, -1)
		parser.NewString("out o", destMp3file)
		printLine()
	...
	if parser.Found("copy-meta") {
		...
		destMp3file = destMp3dir + "Merged_" + filepath.Base(files[tagindex])
	}
